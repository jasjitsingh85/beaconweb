...
$(document).ready(function(){
    ...
    $('.first-box').keyup(function(event){
...
function get_phone_number() {
    var phone = $('.first-box').val() + $('.second-box').val() + $('.third-box').val();
    return phone;
}
...
function sendAppTextLink (phone, success) {
    var text_message_url = url +  'api/text-app-link/';
