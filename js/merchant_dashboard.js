...
//                active_deals = success.active_deals;
    ...
    function fade_out_and_load_merchant_dashboard(deals) {
        $('#login-container').fadeOut(400, load_merchant_dashboard);
        $('#registration-container').fadeOut(400, load_merchant_dashboard);
        place_name = deals.recurring_deal[0].place.name.toUpperCase();
        $('.main').css('background', '#FFFFFF');
        load_place_name();
        merchant.place_id = deals.recurring_deal[0].place.id;
