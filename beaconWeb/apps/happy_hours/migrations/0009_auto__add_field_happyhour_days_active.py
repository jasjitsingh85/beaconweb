...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HappyHour.days_active'
        db.add_column(u'happy_hours_happyhour', 'days_active',
                      self.gf('django.db.models.fields.BigIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HappyHour.days_active'
        db.delete_column(u'happy_hours_happyhour', 'days_active')
