...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'happy_hours_happyhour', 'description', self.gf('django.db.models.fields.CharField')(max_length=1028))

    def backwards(self, orm):

        # Changing field 'HappyHour.description'
        db.alter_column(u'happy_hours_happyhour', 'description', self.gf('django.db.models.fields.CharField')(max_length=128))
