...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.gt_id'
        db.alter_column(u'happy_hours_place', 'gt_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Place.gt_id'
        db.alter_column(u'happy_hours_place', 'gt_id', self.gf('django.db.models.fields.IntegerField')(default=None, unique=True))
