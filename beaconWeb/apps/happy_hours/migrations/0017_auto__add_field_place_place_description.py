...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.place_description'
        db.add_column(u'happy_hours_place', 'place_description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.place_description'
        db.delete_column(u'happy_hours_place', 'place_description')
