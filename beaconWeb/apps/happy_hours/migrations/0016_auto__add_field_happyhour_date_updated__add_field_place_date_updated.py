...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HappyHour.date_updated'
        db.add_column(u'happy_hours_happyhour', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 6, 18, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Place.date_updated'
        db.add_column(u'happy_hours_place', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 6, 18, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HappyHour.date_updated'
        db.delete_column(u'happy_hours_happyhour', 'date_updated')

        # Deleting field 'Place.date_updated'
        db.delete_column(u'happy_hours_place', 'date_updated')
