...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.yelp_review_count'
        db.add_column(u'happy_hours_place', 'yelp_review_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.yelp_review_count'
        db.delete_column(u'happy_hours_place', 'yelp_review_count')
