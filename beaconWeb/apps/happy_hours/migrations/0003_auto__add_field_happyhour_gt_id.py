...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HappyHour.gt_id'
        db.add_column(u'happy_hours_happyhour', 'gt_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, unique=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HappyHour.gt_id'
        db.delete_column(u'happy_hours_happyhour', 'gt_id')
