...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'happy_hours_place', 'image_url',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.yelp_id'
        db.add_column(u'happy_hours_place', 'yelp_id',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'happy_hours_place', 'image_url')

        # Deleting field 'Place.yelp_id'
        db.delete_column(u'happy_hours_place', 'yelp_id')
