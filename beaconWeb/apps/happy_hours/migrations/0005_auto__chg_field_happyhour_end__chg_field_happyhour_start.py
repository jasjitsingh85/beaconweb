...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HappyHour.end'
        db.alter_column(u'happy_hours_happyhour', 'end', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HappyHour.start'
        db.alter_column(u'happy_hours_happyhour', 'start', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'HappyHour.end'
        db.alter_column(u'happy_hours_happyhour', 'end', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'HappyHour.start'
        db.alter_column(u'happy_hours_happyhour', 'start', self.gf('django.db.models.fields.FloatField')(default=0))
