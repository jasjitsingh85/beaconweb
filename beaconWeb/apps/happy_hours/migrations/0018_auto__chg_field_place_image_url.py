...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.image_url'
        db.alter_column(u'happy_hours_place', 'image_url', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Place.image_url'
        db.alter_column(u'happy_hours_place', 'image_url', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
