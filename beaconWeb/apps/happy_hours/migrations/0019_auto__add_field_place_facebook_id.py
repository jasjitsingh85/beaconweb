...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.facebook_id'
        db.add_column(u'happy_hours_place', 'facebook_id',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.facebook_id'
        db.delete_column(u'happy_hours_place', 'facebook_id')
