...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.yelp_rating_image_url'
        db.add_column(u'happy_hours_place', 'yelp_rating_image_url',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.yelp_rating_image_url'
        db.delete_column(u'happy_hours_place', 'yelp_rating_image_url')
