...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactStatus.referring_user'
        db.add_column(u'beacon_contactstatus', 'referring_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactStatus.referring_user'
        db.delete_column(u'beacon_contactstatus', 'referring_user_id')
