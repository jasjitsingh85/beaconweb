...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beacon.cancelled'
        db.add_column(u'beacon_beacon', 'cancelled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beacon.cancelled'
        db.delete_column(u'beacon_beacon', 'cancelled')
    ...
    models = {
        ...
        'beacon.beaconinvite': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 9, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
