...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedCache.date_created'
        db.add_column(u'beacon_feedcache', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 8, 17, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeedCache.date_created'
        db.delete_column(u'beacon_feedcache', 'date_created')
    ...
    models = {
        ...
        'beacon.feedcache': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_url': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
