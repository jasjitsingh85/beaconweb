...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContactStatus'
        db.create_table(u'beacon_contactstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deal_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.DealStatus'])),
            ('sms_response', self.gf('django.db.models.fields.CharField')(default=None, max_length=1)),
            ('link_clicked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['ContactStatus'])


    def backwards(self, orm):
        # Deleting model 'ContactStatus'
        db.delete_table(u'beacon_contactstatus')
    ...
    models = {
        ...
        'beacon.contactstatus': {
            ...
            'sms_response': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1'})
        },
