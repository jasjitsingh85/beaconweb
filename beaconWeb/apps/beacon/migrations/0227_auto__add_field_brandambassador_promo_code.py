...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrandAmbassador.promo_code'
        db.add_column(u'beacon_brandambassador', 'promo_code',
                      self.gf('django.db.models.fields.CharField')(default='null', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrandAmbassador.promo_code'
        db.delete_column(u'beacon_brandambassador', 'promo_code')
    ...
    models = {
        ...
        'beacon.brandambassador': {
            ...
            'promo_code': ('django.db.models.fields.CharField', [], {'max_length': '20'})
        },
        'beacon.cashpayment': {
