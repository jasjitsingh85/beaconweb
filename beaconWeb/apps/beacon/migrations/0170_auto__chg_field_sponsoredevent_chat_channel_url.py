...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SponsoredEvent.chat_channel_url'
        db.alter_column(u'beacon_sponsoredevent', 'chat_channel_url', self.gf('django.db.models.fields.CharField')(default='1fc48.TEST', max_length=100))

    def backwards(self, orm):

        # Changing field 'SponsoredEvent.chat_channel_url'
        db.alter_column(u'beacon_sponsoredevent', 'chat_channel_url', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
