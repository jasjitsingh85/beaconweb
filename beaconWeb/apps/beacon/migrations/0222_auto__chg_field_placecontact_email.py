...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'beacon_placecontact', 'email', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'PlaceContact.email'
        db.alter_column(u'beacon_placecontact', 'email', self.gf('django.db.models.fields.CharField')(max_length=40))
