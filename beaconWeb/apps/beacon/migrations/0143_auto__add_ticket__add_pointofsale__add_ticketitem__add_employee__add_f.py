...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ticket'
        db.create_table(u'beacon_ticket', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('point_of_sale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.PointOfSale'])),
            ('ticket_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Employee'])),
            ('order_type_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('revenue_center_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('table_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('subtotal', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('other_charges', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('service_charges', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ...
            ('convenience_fee', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('tip', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('total', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('payment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tickets', null=True, to=orm['beacon.Payment'])),
            ('date_closed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['Ticket'])

        # Adding model 'PointOfSale'
        db.create_table(u'beacon_pointofsale', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('omnivore_location_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('default_order_type_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('default_revenue_center_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('default_table_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('integration_type', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('point_of_sale_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['PointOfSale'])

        # Adding model 'TicketItem'
        db.create_table(u'beacon_ticketitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Ticket'])),
            ('menu_item_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ...
        db.send_create_signal('beacon', ['TicketItem'])

        # Adding model 'Employee'
        db.create_table(u'beacon_employee', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('employee_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['Employee'])

        # Adding field 'DealPlace.point_of_sale'
        db.add_column(u'beacon_dealplace', 'point_of_sale',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['beacon.PointOfSale'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deal.menu_item_id'
        db.add_column(u'beacon_deal', 'menu_item_id',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'beacon_ticket')

        # Deleting model 'PointOfSale'
        db.delete_table(u'beacon_pointofsale')

        # Deleting model 'TicketItem'
        db.delete_table(u'beacon_ticketitem')

        # Deleting model 'Employee'
        db.delete_table(u'beacon_employee')

        # Deleting field 'DealPlace.point_of_sale'
        db.delete_column(u'beacon_dealplace', 'point_of_sale_id')

        # Deleting field 'Deal.menu_item_id'
        db.delete_column(u'beacon_deal', 'menu_item_id')
    ...
    models = {
        ...
        'beacon.pointofsale': {
            ...
            'default_order_type_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'default_revenue_center_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'default_table_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'integration_type': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'omnivore_location_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
        ...
        'beacon.ticket': {
            ...
            'convenience_fee': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_type_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'other_charges': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'service_charges': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'subtotal': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'table_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'tax': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ticket_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'tip': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
