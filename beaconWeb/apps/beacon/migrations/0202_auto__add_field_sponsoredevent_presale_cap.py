...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SponsoredEvent.presale_cap'
        db.add_column(u'beacon_sponsoredevent', 'presale_cap',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SponsoredEvent.presale_cap'
        db.delete_column(u'beacon_sponsoredevent', 'presale_cap')
