...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SponsoredEvent.event_end'
        db.delete_column(u'beacon_sponsoredevent', 'event_end')

        # Deleting field 'SponsoredEvent.event_start'
        db.delete_column(u'beacon_sponsoredevent', 'event_start')

        # Adding field 'SponsoredEvent.start'
        db.add_column(u'beacon_sponsoredevent', 'start',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 2, 9, 0, 0)),
                      keep_default=False)

        # Adding field 'SponsoredEvent.end'
        db.add_column(u'beacon_sponsoredevent', 'end',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 2, 9, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SponsoredEvent.event_end'
        db.add_column(u'beacon_sponsoredevent', 'event_end',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 2, 9, 0, 0)),
                      keep_default=False)

        # Adding field 'SponsoredEvent.event_start'
        db.add_column(u'beacon_sponsoredevent', 'event_start',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 2, 9, 0, 0)),
                      keep_default=False)

        # Deleting field 'SponsoredEvent.start'
        db.delete_column(u'beacon_sponsoredevent', 'start')

        # Deleting field 'SponsoredEvent.end'
        db.delete_column(u'beacon_sponsoredevent', 'end')
