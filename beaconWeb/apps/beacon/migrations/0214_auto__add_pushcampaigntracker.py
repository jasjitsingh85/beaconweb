...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PushCampaignTracker'
        db.create_table(u'beacon_pushcampaigntracker', (
            ...
            ('total_sent', self.gf('django.db.models.fields.FloatField')()),
            ('date_sent', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['PushCampaignTracker'])


    def backwards(self, orm):
        # Deleting model 'PushCampaignTracker'
        db.delete_table(u'beacon_pushcampaigntracker')
    ...
    models = {
        ...
        'beacon.pushcampaigntracker': {
            'Meta': {'object_name': 'PushCampaignTracker'},
            'date_sent': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.SponsoredEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
