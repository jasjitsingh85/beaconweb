...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventStatus.arrival_message_sent'
        db.add_column(u'beacon_eventstatus', 'arrival_message_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventStatus.arrival_message_sent'
        db.delete_column(u'beacon_eventstatus', 'arrival_message_sent')
