...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Tab'
        db.create_table(u'beacon_tab', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tabs', to=orm['auth.User'])),
            ('point_of_sale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.PointOfSale'])),
            ('omnivore_tab_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('tab_claimed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Employee'])),
            ('order_type_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('revenue_center_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('table_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('subtotal', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('other_charges', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('service_charges', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ...
            ('convenience_fee', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('tip', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('total', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('payment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tabs', null=True, to=orm['beacon.Payment'])),
        ...
        db.send_create_signal('beacon', ['Tab'])

        # Adding model 'TabItem'
        db.create_table(u'beacon_tabitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tab', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Tab'])),
            ('menu_item_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('price', self.gf('django.db.models.fields.FloatField')()),
            ('deal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Deal'], null=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['TabItem'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'beacon_ticket', (
            ('date_closed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('ticket_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('other_charges', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', to=orm['auth.User'])),
            ('convenience_fee', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('service_charges', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('table_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('payment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', null=True, to=orm['beacon.Payment'], blank=True)),
            ('discount', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('order_type_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('point_of_sale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.PointOfSale'])),
            ('tip', self.gf('django.db.models.fields.FloatField')(default=0.0)),
        ...
        # Deleting model 'Tab'
        db.delete_table(u'beacon_tab')

        # Deleting model 'TabItem'
        db.delete_table(u'beacon_tabitem')
    ...
    models = {
        ...
        'beacon.deal': {
            ...
            'menu_price_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
        ...
        'beacon.pointofsale': {
            ...
            'default_employee_id': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
        ...
        'beacon.tab': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'omnivore_tab_id': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
