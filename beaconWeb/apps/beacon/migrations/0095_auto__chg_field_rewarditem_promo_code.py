...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RewardItem.promo_code'
        db.alter_column(u'beacon_rewarditem', 'promo_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'RewardItem.promo_code'
        db.alter_column(u'beacon_rewarditem', 'promo_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
