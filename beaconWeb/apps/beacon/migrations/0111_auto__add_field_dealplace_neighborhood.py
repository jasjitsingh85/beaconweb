...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealPlace.neighborhood'
        db.add_column(u'beacon_dealplace', 'neighborhood',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealPlace.neighborhood'
        db.delete_column(u'beacon_dealplace', 'neighborhood')
