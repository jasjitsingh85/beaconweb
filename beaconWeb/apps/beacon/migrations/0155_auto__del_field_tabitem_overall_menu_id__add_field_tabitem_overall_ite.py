...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TabItem.overall_menu_id'
        db.delete_column(u'beacon_tabitem', 'overall_menu_id')

        # Adding field 'TabItem.overall_item_id'
        db.add_column(u'beacon_tabitem', 'overall_item_id',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TabItem.overall_menu_id'
        db.add_column(u'beacon_tabitem', 'overall_menu_id',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128),
                      keep_default=False)

        # Deleting field 'TabItem.overall_item_id'
        db.delete_column(u'beacon_tabitem', 'overall_item_id')
