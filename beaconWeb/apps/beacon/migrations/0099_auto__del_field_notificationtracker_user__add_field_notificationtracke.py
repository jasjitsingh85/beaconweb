...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NotificationTracker.user'
        db.delete_column(u'beacon_notificationtracker', 'user_id')

        # Adding field 'NotificationTracker.recipient'
        db.add_column(u'beacon_notificationtracker', 'recipient',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='receiving_user', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'NotificationTracker.sender'
        db.add_column(u'beacon_notificationtracker', 'sender',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sending_user', null=True, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'NotificationTracker.notification_detail'
        db.alter_column(u'beacon_notificationtracker', 'notification_detail', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):
        # Adding field 'NotificationTracker.user'
        db.add_column(u'beacon_notificationtracker', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'NotificationTracker.recipient'
        db.delete_column(u'beacon_notificationtracker', 'recipient_id')

        # Deleting field 'NotificationTracker.sender'
        db.delete_column(u'beacon_notificationtracker', 'sender_id')


        # Changing field 'NotificationTracker.notification_detail'
        db.alter_column(u'beacon_notificationtracker', 'notification_detail', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
