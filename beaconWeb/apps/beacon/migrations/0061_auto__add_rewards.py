...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'beacon_rewards', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('reward_type', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('deal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Deal'], null=True, blank=True)),
            ('reward_value', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('isRedeemed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('beacon', ['Rewards'])


    def backwards(self, orm):
        # Deleting model 'Rewards'
        db.delete_table(u'beacon_rewards')
    ...
    models = {
        ...
        'beacon.rewards': {
            ...
            'reward_value': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
