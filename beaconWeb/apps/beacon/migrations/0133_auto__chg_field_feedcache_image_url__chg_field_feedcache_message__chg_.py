...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedCache.image_url'
        db.alter_column(u'beacon_feedcache', 'image_url', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

        # Changing field 'FeedCache.message'
        db.alter_column(u'beacon_feedcache', 'message', self.gf('django.db.models.fields.CharField')(max_length=10000, null=True))

        # Changing field 'FeedCache.content_id'
        db.alter_column(u'beacon_feedcache', 'content_id', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'FeedCache.image_url'
        db.alter_column(u'beacon_feedcache', 'image_url', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True))

        # Changing field 'FeedCache.message'
        db.alter_column(u'beacon_feedcache', 'message', self.gf('django.db.models.fields.CharField')(max_length=5000, null=True))

        # Changing field 'FeedCache.content_id'
        db.alter_column(u'beacon_feedcache', 'content_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
