...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SyndicatedEvents'
        db.create_table(u'beacon_syndicatedevents', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('website', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_place', to=orm['beacon.DealPlace'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['SyndicatedEvents'])


    def backwards(self, orm):
        # Deleting model 'SyndicatedEvents'
        db.delete_table(u'beacon_syndicatedevents')
