...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Feedback.deal_status'
        db.delete_column(u'beacon_feedback', 'deal_status_id')

        # Adding field 'DealStatus.feedback'
        db.add_column(u'beacon_dealstatus', 'feedback',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Feedback'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Feedback.deal_status'
        db.add_column(u'beacon_feedback', 'deal_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='deal_feedback', to=orm['beacon.DealStatus']),
                      keep_default=False)

        # Deleting field 'DealStatus.feedback'
        db.delete_column(u'beacon_dealstatus', 'feedback_id')
