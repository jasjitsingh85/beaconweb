...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatingMatch'
        db.create_table(u'beacon_datingmatch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dating_profile_selector', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dating_selector', to=orm['beacon.DatingProfile'])),
            ('dating_profile_selectee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dating_selectee', to=orm['beacon.DatingProfile'])),
            ('is_selected', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['DatingMatch'])


    def backwards(self, orm):
        # Deleting model 'DatingMatch'
        db.delete_table(u'beacon_datingmatch')
