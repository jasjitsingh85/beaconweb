...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RawHappyHour.latitude'
        db.alter_column(u'beacon_rawhappyhour', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'RawHappyHour.cuisine_label'
        db.alter_column(u'beacon_rawhappyhour', 'cuisine_label', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'RawHappyHour.start_time'
        db.alter_column(u'beacon_rawhappyhour', 'start_time', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'RawHappyHour.days'
        db.alter_column(u'beacon_rawhappyhour', 'days', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'RawHappyHour.longitude'
        db.alter_column(u'beacon_rawhappyhour', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'RawHappyHour.name'
        db.alter_column(u'beacon_rawhappyhour', 'name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'RawHappyHour.phone'
        db.alter_column(u'beacon_rawhappyhour', 'phone', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'RawHappyHour.street'
        db.alter_column(u'beacon_rawhappyhour', 'street', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'RawHappyHour.end_time'
        db.alter_column(u'beacon_rawhappyhour', 'end_time', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'RawHappyHour.latitude'
        db.alter_column(u'beacon_rawhappyhour', 'latitude', self.gf('django.db.models.fields.FloatField')(default=' '))

        # Changing field 'RawHappyHour.cuisine_label'
        db.alter_column(u'beacon_rawhappyhour', 'cuisine_label', self.gf('django.db.models.fields.CharField')(default=' ', max_length=128))

        # Changing field 'RawHappyHour.start_time'
        db.alter_column(u'beacon_rawhappyhour', 'start_time', self.gf('django.db.models.fields.CharField')(default=' ', max_length=128))

        # Changing field 'RawHappyHour.days'
        db.alter_column(u'beacon_rawhappyhour', 'days', self.gf('django.db.models.fields.CharField')(default=' ', max_length=128))

        # Changing field 'RawHappyHour.longitude'
        db.alter_column(u'beacon_rawhappyhour', 'longitude', self.gf('django.db.models.fields.FloatField')(default=' '))

        # Changing field 'RawHappyHour.name'
        db.alter_column(u'beacon_rawhappyhour', 'name', self.gf('django.db.models.fields.CharField')(default=' ', max_length=128))

        # Changing field 'RawHappyHour.phone'
        db.alter_column(u'beacon_rawhappyhour', 'phone', self.gf('django.db.models.fields.CharField')(default=' ', max_length=128))

        # Changing field 'RawHappyHour.street'
        db.alter_column(u'beacon_rawhappyhour', 'street', self.gf('django.db.models.fields.CharField')(default=' ', max_length=128))

        # Changing field 'RawHappyHour.end_time'
        db.alter_column(u'beacon_rawhappyhour', 'end_time', self.gf('django.db.models.fields.CharField')(default=' ', max_length=128))
    ...
    models = {
        ...
        'beacon.rawhappyhour': {
            ...
            'cuisine_label': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'days': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info_id': ('django.db.models.fields.IntegerField', [], {'unique': 'True', 'db_index': 'True'}),
            ...
            'start_time': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
