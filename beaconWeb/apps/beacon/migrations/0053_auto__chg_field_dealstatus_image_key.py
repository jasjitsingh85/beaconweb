...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DealStatus.image_key'
        db.alter_column(u'beacon_dealstatus', 'image_key', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'DealStatus.image_key'
        db.alter_column(u'beacon_dealstatus', 'image_key', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        'beacon.dealstatus': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_key': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
