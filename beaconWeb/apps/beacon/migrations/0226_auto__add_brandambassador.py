...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BrandAmbassador'
        db.create_table(u'beacon_brandambassador', (
        ...
        db.send_create_signal('beacon', ['BrandAmbassador'])


    def backwards(self, orm):
        # Deleting model 'BrandAmbassador'
        db.delete_table(u'beacon_brandambassador')
    ...
    models = {
        ...
        'beacon.brandambassador': {
            'Meta': {'object_name': 'BrandAmbassador'},
        ...
        'beacon.emailcampaigntracker': {
            ...
            'cash_payment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.CashPayment']", 'null': 'True', 'blank': 'True'}),
            ...
            'email': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.Emails']", 'null': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.SponsoredEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'beacon.emailresponse': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.EmailStatus']", 'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'beacon.emails': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'market': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.Market']"}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'PG'", 'max_length': '2'})
        },
        'beacon.emailstatus': {
        ...
        'beacon.sponsoredevent': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {}),
            'facebook_campaign_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'facebook_event_id': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_cost': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'item_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'item_price': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'market': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.Market']", 'null': 'True', 'blank': 'True'}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.DealPlace']", 'null': 'True', 'blank': 'True'}),
