...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SyndicatedDeal.in_review'
        db.add_column(u'beacon_syndicateddeal', 'in_review',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DealPlace.in_review'
        db.add_column(u'beacon_dealplace', 'in_review',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SyndicatedDeal.in_review'
        db.delete_column(u'beacon_syndicateddeal', 'in_review')

        # Deleting field 'DealPlace.in_review'
        db.delete_column(u'beacon_dealplace', 'in_review')
