...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SyndicatedDeal.days'
        db.add_column(u'beacon_syndicateddeal', 'days',
                      self.gf('django.db.models.fields.CharField')(default='1111111', max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SyndicatedDeal.days'
        db.delete_column(u'beacon_syndicateddeal', 'days')
