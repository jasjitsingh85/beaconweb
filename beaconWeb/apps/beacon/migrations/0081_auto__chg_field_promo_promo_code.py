...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Promo.promo_code'
        db.alter_column(u'beacon_promo', 'promo_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))

    def backwards(self, orm):

        # Changing field 'Promo.promo_code'
        db.alter_column(u'beacon_promo', 'promo_code', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))
