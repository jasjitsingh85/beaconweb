...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'beacon_groupmember', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='members', to=orm['beacon.ContactGroup'])),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Contact'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['GroupMember'])

        # Adding model 'ContactGroup'
        db.create_table(u'beacon_contactgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_groups', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['ContactGroup'])


    def backwards(self, orm):
        # Deleting model 'GroupMember'
        db.delete_table(u'beacon_groupmember')

        # Deleting model 'ContactGroup'
        db.delete_table(u'beacon_contactgroup')
