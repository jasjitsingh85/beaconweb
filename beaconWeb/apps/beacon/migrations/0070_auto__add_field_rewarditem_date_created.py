...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RewardItem.date_created'
        db.add_column(u'beacon_rewarditem', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 6, 29, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RewardItem.date_created'
        db.delete_column(u'beacon_rewarditem', 'date_created')
