...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventManager'
        db.create_table(u'beacon_eventmanager', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('market', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Market'])),
        ...
        db.send_create_signal('beacon', ['EventManager'])

        # Adding model 'EventStaffer'
        db.create_table(u'beacon_eventstaffer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('is_staffed', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['EventStaffer'])

        # Adding model 'Market'
        db.create_table(u'beacon_market', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal('beacon', ['Market'])


    def backwards(self, orm):
        # Deleting model 'EventManager'
        db.delete_table(u'beacon_eventmanager')

        # Deleting model 'EventStaffer'
        db.delete_table(u'beacon_eventstaffer')

        # Deleting model 'Market'
        db.delete_table(u'beacon_market')
