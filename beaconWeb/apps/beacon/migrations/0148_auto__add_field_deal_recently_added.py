...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.recently_added'
        db.add_column(u'beacon_deal', 'recently_added',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.recently_added'
        db.delete_column(u'beacon_deal', 'recently_added')
