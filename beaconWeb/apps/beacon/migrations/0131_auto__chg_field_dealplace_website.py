...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DealPlace.website'
        db.alter_column(u'beacon_dealplace', 'website', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'DealPlace.website'
        db.alter_column(u'beacon_dealplace', 'website', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
