...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tab.tab_id'
        db.delete_column(u'beacon_tab', 'tab_id')

        # Adding field 'Tab.api_tab_id'
        db.add_column(u'beacon_tab', 'api_tab_id',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128),
                      keep_default=False)


        # Changing field 'Tab.convenience_fee'
        db.alter_column(u'beacon_tab', 'convenience_fee', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Tab.other_charges'
        db.alter_column(u'beacon_tab', 'other_charges', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Tab.tip'
        db.alter_column(u'beacon_tab', 'tip', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Tab.service_charges'
        db.alter_column(u'beacon_tab', 'service_charges', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Tab.discount'
        db.alter_column(u'beacon_tab', 'discount', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Tab.tax'
        db.alter_column(u'beacon_tab', 'tax', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Tab.total'
        db.alter_column(u'beacon_tab', 'total', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Tab.subtotal'
        db.alter_column(u'beacon_tab', 'subtotal', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))
        # Deleting field 'PointOfSale.default_employee_id'
        db.delete_column(u'beacon_pointofsale', 'default_employee_id')

        # Adding field 'PointOfSale.default_employee'
        db.add_column(u'beacon_pointofsale', 'default_employee',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['beacon.Employee']),
                      keep_default=False)


        # Changing field 'TabItem.price'
        db.alter_column(u'beacon_tabitem', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):
        # Adding field 'Tab.tab_id'
        db.add_column(u'beacon_tab', 'tab_id',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128),
                      keep_default=False)

        # Deleting field 'Tab.api_tab_id'
        db.delete_column(u'beacon_tab', 'api_tab_id')


        # Changing field 'Tab.convenience_fee'
        db.alter_column(u'beacon_tab', 'convenience_fee', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Tab.other_charges'
        db.alter_column(u'beacon_tab', 'other_charges', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Tab.tip'
        db.alter_column(u'beacon_tab', 'tip', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Tab.service_charges'
        db.alter_column(u'beacon_tab', 'service_charges', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Tab.discount'
        db.alter_column(u'beacon_tab', 'discount', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Tab.tax'
        db.alter_column(u'beacon_tab', 'tax', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Tab.total'
        db.alter_column(u'beacon_tab', 'total', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Tab.subtotal'
        db.alter_column(u'beacon_tab', 'subtotal', self.gf('django.db.models.fields.FloatField')())
        # Adding field 'PointOfSale.default_employee_id'
        db.add_column(u'beacon_pointofsale', 'default_employee_id',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128),
                      keep_default=False)

        # Deleting field 'PointOfSale.default_employee'
        db.delete_column(u'beacon_pointofsale', 'default_employee_id')


        # Changing field 'TabItem.price'
        db.alter_column(u'beacon_tabitem', 'price', self.gf('django.db.models.fields.FloatField')())
