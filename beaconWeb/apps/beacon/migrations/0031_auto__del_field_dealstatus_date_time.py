...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DealStatus.date_time'
        db.delete_column(u'beacon_dealstatus', 'date_time')


    def backwards(self, orm):
        # Adding field 'DealStatus.date_time'
        db.add_column(u'beacon_dealstatus', 'date_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 2, 0, 0)),
                      keep_default=False)
