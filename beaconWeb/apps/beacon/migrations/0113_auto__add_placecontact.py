...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlaceContact'
        db.create_table(u'beacon_placecontact', (
        ...
        db.send_create_signal('beacon', ['PlaceContact'])


    def backwards(self, orm):
        # Deleting model 'PlaceContact'
        db.delete_table(u'beacon_placecontact')
