...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.beacon'
        db.delete_column(u'beacon_message', 'beacon_id')

        # Deleting field 'Message.avatar_url'
        db.delete_column(u'beacon_message', 'avatar_url')

        # Deleting field 'Message.chat_type'
        db.delete_column(u'beacon_message', 'chat_type')

        # Deleting field 'Message.image'
        db.delete_column(u'beacon_message', 'image_id')

        # Deleting field 'Message.contact'
        db.delete_column(u'beacon_message', 'contact_id')

        # Adding field 'Message.event'
        db.add_column(u'beacon_message', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.SponsoredEvent'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Message.image_url'
        db.add_column(u'beacon_message', 'image_url',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Message.beacon'
        db.add_column(u'beacon_message', 'beacon',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['beacon.Beacon']),
                      keep_default=False)

        # Adding field 'Message.avatar_url'
        db.add_column(u'beacon_message', 'avatar_url',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Message.chat_type'
        db.add_column(u'beacon_message', 'chat_type',
                      self.gf('django.db.models.fields.CharField')(default='UM', max_length=10),
                      keep_default=False)

        # Adding field 'Message.image'
        db.add_column(u'beacon_message', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Image'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Message.contact'
        db.add_column(u'beacon_message', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Contact'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Message.event'
        db.delete_column(u'beacon_message', 'event_id')

        # Deleting field 'Message.image_url'
        db.delete_column(u'beacon_message', 'image_url')
