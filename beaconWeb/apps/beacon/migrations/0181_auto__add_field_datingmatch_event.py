...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatingMatch.event'
        db.add_column(u'beacon_datingmatch', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=6, to=orm['beacon.SponsoredEvent']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatingMatch.event'
        db.delete_column(u'beacon_datingmatch', 'event_id')
