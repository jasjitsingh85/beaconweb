...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'beacon_placephotos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.DealPlace'])),
            ('source_image_url', self.gf('django.db.models.fields.CharField')(max_length=400)),
            ('like_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('comment_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('tag_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['PlacePhotos'])


    def backwards(self, orm):
        # Deleting model 'PlacePhotos'
        db.delete_table(u'beacon_placephotos')
