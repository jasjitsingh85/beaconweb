...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SyndicatedEvents.start_time'
        db.delete_column(u'beacon_syndicatedevents', 'start_time')

        # Adding field 'SyndicatedEvents.start'
        db.add_column(u'beacon_syndicatedevents', 'start',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 10, 4, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SyndicatedEvents.start_time'
        db.add_column(u'beacon_syndicatedevents', 'start_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 10, 4, 0, 0)),
                      keep_default=False)

        # Deleting field 'SyndicatedEvents.start'
        db.delete_column(u'beacon_syndicatedevents', 'start')
