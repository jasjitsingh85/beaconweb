...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailStatus.user_agent'
        db.alter_column(u'beacon_emailstatus', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'EmailStatus.user_agent'
        db.alter_column(u'beacon_emailstatus', 'user_agent', self.gf('django.db.models.fields.CharField')(default='migration', max_length=1000))
