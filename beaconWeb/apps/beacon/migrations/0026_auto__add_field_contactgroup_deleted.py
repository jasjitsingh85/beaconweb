...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactGroup.deleted'
        db.add_column(u'beacon_contactgroup', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactGroup.deleted'
        db.delete_column(u'beacon_contactgroup', 'deleted')
