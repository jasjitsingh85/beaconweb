...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventStatus.refund_authorization'
        db.add_column(u'beacon_eventstatus', 'refund_authorization',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventStatus.refund_authorization'
        db.delete_column(u'beacon_eventstatus', 'refund_authorization')
