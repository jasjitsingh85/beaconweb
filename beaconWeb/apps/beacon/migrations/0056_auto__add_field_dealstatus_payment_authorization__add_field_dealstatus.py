...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealStatus.payment_authorization'
        db.add_column(u'beacon_dealstatus', 'payment_authorization',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DealStatus.isSubmitted'
        db.add_column(u'beacon_dealstatus', 'isSubmitted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealStatus.payment_authorization'
        db.delete_column(u'beacon_dealstatus', 'payment_authorization')

        # Deleting field 'DealStatus.isSubmitted'
        db.delete_column(u'beacon_dealstatus', 'isSubmitted')
