...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RawHappyHour.info_id'
        db.delete_column(u'beacon_rawhappyhour', 'info_id')

        # Adding field 'RawHappyHour.gt_id'
        db.add_column(u'beacon_rawhappyhour', 'gt_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RawHappyHour.place'
        db.add_column(u'beacon_rawhappyhour', 'place',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.DealPlace'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RawHappyHour.info_id'
        db.add_column(u'beacon_rawhappyhour', 'info_id',
                      self.gf('django.db.models.fields.IntegerField')(default=' ', unique=True, db_index=True),
                      keep_default=False)

        # Deleting field 'RawHappyHour.gt_id'
        db.delete_column(u'beacon_rawhappyhour', 'gt_id')

        # Deleting field 'RawHappyHour.place'
        db.delete_column(u'beacon_rawhappyhour', 'place_id')
