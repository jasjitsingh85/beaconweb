...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'beacon_message', 'avatar_url',
                      self.gf('django.db.models.fields.CharField')(default='https://s3.amazonaws.com/hotbot-images/HotbotNeutral.png', max_length=100),
                      keep_default=False)
    ...
    models = {
        ...
        'beacon.beaconinvite': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'beacon.message': {
            ...
            'avatar_url': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'beacon': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.Beacon']"}),
