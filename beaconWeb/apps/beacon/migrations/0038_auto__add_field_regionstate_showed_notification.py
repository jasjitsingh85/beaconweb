...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegionState.showed_notification'
        db.add_column(u'beacon_regionstate', 'showed_notification',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegionState.showed_notification'
        db.delete_column(u'beacon_regionstate', 'showed_notification')
