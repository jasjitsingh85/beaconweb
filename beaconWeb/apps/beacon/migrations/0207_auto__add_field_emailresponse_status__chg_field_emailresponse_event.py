...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailResponse.status'
        db.add_column(u'beacon_emailresponse', 'status',
                      self.gf('django.db.models.fields.CharField')(default='UN', max_length=2),
                      keep_default=False)


        # Changing field 'EmailResponse.event'
        db.alter_column(u'beacon_emailresponse', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.SponsoredEvent'], null=True))

    def backwards(self, orm):
        # Deleting field 'EmailResponse.status'
        db.delete_column(u'beacon_emailresponse', 'status')


        # Changing field 'EmailResponse.event'
        db.alter_column(u'beacon_emailresponse', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['beacon.SponsoredEvent']))
