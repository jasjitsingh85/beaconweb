...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventHours'
        db.create_table(u'beacon_eventhours', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hours', to=orm['beacon.SponsoredEvent'])),
            ('event_start', self.gf('django.db.models.fields.DateTimeField')()),
            ('event_end', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('beacon', ['EventHours'])

        # Adding model 'EventStatus'
        db.create_table(u'beacon_eventstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_statuses', to=orm['beacon.SponsoredEvent'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='L', max_length=10)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='event_statuses', null=True, to=orm['auth.User'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('image_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('payment_authorization', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ...
            ('payment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='event_statuses', null=True, to=orm['beacon.Payment'])),
        ))
        db.send_create_signal('beacon', ['EventStatus'])

        # Adding model 'SponsoredEvent'
        db.create_table(u'beacon_sponsoredevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.DealPlace'])),
            ('event_description_short', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('invite_prompt', self.gf('django.db.models.fields.TextField')()),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('item_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('item_cost', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('item_price', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('capacity', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['SponsoredEvent'])


    def backwards(self, orm):
        # Deleting model 'EventHours'
        db.delete_table(u'beacon_eventhours')

        # Deleting model 'EventStatus'
        db.delete_table(u'beacon_eventstatus')

        # Deleting model 'SponsoredEvent'
        db.delete_table(u'beacon_sponsoredevent')
    ...
    models = {
        ...
        'beacon.eventhours': {
            'Meta': {'object_name': 'EventHours'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'hours'", 'to': "orm['beacon.SponsoredEvent']"}),
        ...
        'beacon.eventstatus': {
            ...
            'present': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'L'", 'max_length': '10'}),
        ...
        'beacon.sponsoredevent': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'event_description_short': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_prompt': ('django.db.models.fields.TextField', [], {}),
            'item_cost': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'item_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
