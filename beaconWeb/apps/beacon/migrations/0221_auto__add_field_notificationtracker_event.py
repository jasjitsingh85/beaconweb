...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotificationTracker.event'
        db.add_column(u'beacon_notificationtracker', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.SponsoredEvent'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotificationTracker.event'
        db.delete_column(u'beacon_notificationtracker', 'event_id')
