...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RawHappyHour'
        db.create_table(u'beacon_rawhappyhour', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('info_id', self.gf('django.db.models.fields.IntegerField')(unique=True, db_index=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('company_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('cuisine_label', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ...
            ('days', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('start_time', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('end_time', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['RawHappyHour'])


    def backwards(self, orm):
        # Deleting model 'RawHappyHour'
        db.delete_table(u'beacon_rawhappyhour')
    ...
    models = {
        ...
        'beacon.rawhappyhour': {
            ...
            'cuisine_label': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'days': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
