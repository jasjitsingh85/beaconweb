...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.invite_requirement'
        db.add_column(u'beacon_deal', 'invite_requirement',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Deal.bonus_invite_requirement'
        db.add_column(u'beacon_deal', 'bonus_invite_requirement',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.invite_requirement'
        db.delete_column(u'beacon_deal', 'invite_requirement')

        # Deleting field 'Deal.bonus_invite_requirement'
        db.delete_column(u'beacon_deal', 'bonus_invite_requirement')
