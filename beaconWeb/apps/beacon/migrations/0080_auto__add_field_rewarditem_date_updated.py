...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RewardItem.date_updated'
        db.add_column(u'beacon_rewarditem', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 7, 26, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RewardItem.date_updated'
        db.delete_column(u'beacon_rewarditem', 'date_updated')
    ...
    models = {
        ...
        'beacon.promo': {
            ...
            'promo_code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10'}),
            'referring_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
