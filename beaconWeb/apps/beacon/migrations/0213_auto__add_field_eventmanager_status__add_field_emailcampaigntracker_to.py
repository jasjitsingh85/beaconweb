...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventManager.status'
        db.add_column(u'beacon_eventmanager', 'status',
                      self.gf('django.db.models.fields.CharField')(default='PR', max_length=2),
                      keep_default=False)

        # Adding field 'EmailCampaignTracker.total_sent'
        db.add_column(u'beacon_emailcampaigntracker', 'total_sent',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventManager.status'
        db.delete_column(u'beacon_eventmanager', 'status')

        # Deleting field 'EmailCampaignTracker.total_sent'
        db.delete_column(u'beacon_emailcampaigntracker', 'total_sent')
    ...
    models = {
        ...
        'beacon.emailcampaigntracker': {
            'Meta': {'object_name': 'EmailCampaignTracker'},
            ...
            'total_sent': ('django.db.models.fields.FloatField', [], {}),
