...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContactStatus.sms_response'
        db.alter_column(u'beacon_contactstatus', 'sms_response', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

    def backwards(self, orm):

        # Changing field 'ContactStatus.sms_response'
        db.alter_column(u'beacon_contactstatus', 'sms_response', self.gf('django.db.models.fields.CharField')(default=1, max_length=1))
