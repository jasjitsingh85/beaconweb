...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.deal_description_short'
        db.add_column(u'beacon_deal', 'deal_description_short',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deal.bonus_description_short'
        db.add_column(u'beacon_deal', 'bonus_description_short',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.deal_description_short'
        db.delete_column(u'beacon_deal', 'deal_description_short')

        # Deleting field 'Deal.bonus_description_short'
        db.delete_column(u'beacon_deal', 'bonus_description_short')
