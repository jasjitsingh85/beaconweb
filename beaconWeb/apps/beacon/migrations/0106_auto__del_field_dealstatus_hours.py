...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DealStatus.hours'
        db.delete_column(u'beacon_dealstatus', 'hours_id')


    def backwards(self, orm):
        # Adding field 'DealStatus.hours'
        db.add_column(u'beacon_dealstatus', 'hours',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='deal_statuses', to=orm['beacon.DealHours']),
                      keep_default=False)
