...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SponsoredEvent.facebook_event_id'
        db.add_column(u'beacon_sponsoredevent', 'facebook_event_id',
                      self.gf('django.db.models.fields.CharField')(default='153623421686445', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SponsoredEvent.facebook_event_id'
        db.delete_column(u'beacon_sponsoredevent', 'facebook_event_id')
