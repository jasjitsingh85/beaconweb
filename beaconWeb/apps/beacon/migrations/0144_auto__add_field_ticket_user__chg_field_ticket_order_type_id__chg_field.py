...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'beacon_ticket', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='tickets', to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'Ticket.order_type_id'
        db.alter_column(u'beacon_ticket', 'order_type_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=128))

        # Changing field 'Ticket.other_charges'
        db.alter_column(u'beacon_ticket', 'other_charges', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Ticket.convenience_fee'
        db.alter_column(u'beacon_ticket', 'convenience_fee', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Ticket.service_charges'
        db.alter_column(u'beacon_ticket', 'service_charges', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Ticket.discount'
        db.alter_column(u'beacon_ticket', 'discount', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Ticket.tip'
        db.alter_column(u'beacon_ticket', 'tip', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Ticket.table_id'
        db.alter_column(u'beacon_ticket', 'table_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=128))

        # Changing field 'Ticket.revenue_center_id'
        db.alter_column(u'beacon_ticket', 'revenue_center_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=128))

        # Changing field 'Ticket.tax'
        db.alter_column(u'beacon_ticket', 'tax', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Ticket.total'
        db.alter_column(u'beacon_ticket', 'total', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Ticket.subtotal'
        db.alter_column(u'beacon_ticket', 'subtotal', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Ticket.ticket_id'
        db.alter_column(u'beacon_ticket', 'ticket_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=128))
        # Adding field 'PointOfSale.system_type'
        db.add_column(u'beacon_pointofsale', 'system_type',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=10),
                      keep_default=False)


        # Changing field 'PointOfSale.integration_type'
        db.alter_column(u'beacon_pointofsale', 'integration_type', self.gf('django.db.models.fields.CharField')(default=1, max_length=10))

        # Changing field 'PointOfSale.default_table_id'
        db.alter_column(u'beacon_pointofsale', 'default_table_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=128))

        # Changing field 'PointOfSale.default_revenue_center_id'
        db.alter_column(u'beacon_pointofsale', 'default_revenue_center_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=128))

        # Changing field 'PointOfSale.default_order_type_id'
        db.alter_column(u'beacon_pointofsale', 'default_order_type_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=128))

        # Changing field 'PointOfSale.omnivore_location_id'
        db.alter_column(u'beacon_pointofsale', 'omnivore_location_id', self.gf('django.db.models.fields.CharField')(default=1, unique=True, max_length=128))
        # Adding unique constraint on 'PointOfSale', fields ['omnivore_location_id']
        db.create_unique(u'beacon_pointofsale', ['omnivore_location_id'])


        # Changing field 'TicketItem.name'
        db.alter_column(u'beacon_ticketitem', 'name', self.gf('django.db.models.fields.CharField')(default=1, max_length=128))

        # Changing field 'TicketItem.price'
        db.alter_column(u'beacon_ticketitem', 'price', self.gf('django.db.models.fields.FloatField')(default=1))

        # Changing field 'TicketItem.menu_item_id'
        db.alter_column(u'beacon_ticketitem', 'menu_item_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=128))

    def backwards(self, orm):
        # Removing unique constraint on 'PointOfSale', fields ['omnivore_location_id']
        db.delete_unique(u'beacon_pointofsale', ['omnivore_location_id'])

        # Deleting field 'Ticket.user'
        db.delete_column(u'beacon_ticket', 'user_id')


        # Changing field 'Ticket.order_type_id'
        db.alter_column(u'beacon_ticket', 'order_type_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Ticket.other_charges'
        db.alter_column(u'beacon_ticket', 'other_charges', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Ticket.convenience_fee'
        db.alter_column(u'beacon_ticket', 'convenience_fee', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Ticket.service_charges'
        db.alter_column(u'beacon_ticket', 'service_charges', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Ticket.discount'
        db.alter_column(u'beacon_ticket', 'discount', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Ticket.tip'
        db.alter_column(u'beacon_ticket', 'tip', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Ticket.table_id'
        db.alter_column(u'beacon_ticket', 'table_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Ticket.revenue_center_id'
        db.alter_column(u'beacon_ticket', 'revenue_center_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Ticket.tax'
        db.alter_column(u'beacon_ticket', 'tax', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Ticket.total'
        db.alter_column(u'beacon_ticket', 'total', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Ticket.subtotal'
        db.alter_column(u'beacon_ticket', 'subtotal', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Ticket.ticket_id'
        db.alter_column(u'beacon_ticket', 'ticket_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
        # Deleting field 'PointOfSale.system_type'
        db.delete_column(u'beacon_pointofsale', 'system_type')


        # Changing field 'PointOfSale.integration_type'
        db.alter_column(u'beacon_pointofsale', 'integration_type', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'PointOfSale.default_table_id'
        db.alter_column(u'beacon_pointofsale', 'default_table_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'PointOfSale.default_revenue_center_id'
        db.alter_column(u'beacon_pointofsale', 'default_revenue_center_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'PointOfSale.default_order_type_id'
        db.alter_column(u'beacon_pointofsale', 'default_order_type_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'PointOfSale.omnivore_location_id'
        db.alter_column(u'beacon_pointofsale', 'omnivore_location_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'TicketItem.name'
        db.alter_column(u'beacon_ticketitem', 'name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'TicketItem.price'
        db.alter_column(u'beacon_ticketitem', 'price', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'TicketItem.menu_item_id'
        db.alter_column(u'beacon_ticketitem', 'menu_item_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
    ...
    models = {
        ...
        'beacon.deal': {
            ...
            'menu_item_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
        ...
        'beacon.employee': {
            ...
            'employee_id': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
        ...
        'beacon.pointofsale': {
            ...
            'omnivore_location_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
        ...
        'beacon.ticket': {
            ...
            'convenience_fee': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            ...
            'other_charges': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'payment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tickets'", 'null': 'True', 'to': "orm['beacon.Payment']"}),
            'point_of_sale': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.PointOfSale']"}),
            'revenue_center_id': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'service_charges': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'subtotal': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'table_id': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'tax': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'ticket_id': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'tip': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'total': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tickets'", 'to': u"orm['auth.User']"})
        },
        'beacon.ticketitem': {
            ...
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.Ticket']"})
        },
        'beacon.unsubscribe': {
