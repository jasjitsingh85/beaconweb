...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.is_venmo_enabled'
        db.delete_column(u'beacon_profile', 'is_venmo_enabled')

        # Deleting field 'Profile.venmo_auth_token'
        db.delete_column(u'beacon_profile', 'venmo_auth_token')

        # Adding field 'Profile.fb_token'
        db.add_column(u'beacon_profile', 'fb_token',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.is_venmo_enabled'
        db.add_column(u'beacon_profile', 'is_venmo_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profile.venmo_auth_token'
        db.add_column(u'beacon_profile', 'venmo_auth_token',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Profile.fb_token'
        db.delete_column(u'beacon_profile', 'fb_token')
