...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ViewTracker'
        db.create_table(u'beacon_viewtracker', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('view_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('view_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['ViewTracker'])


        # Changing field 'NotificationTracker.notification_type'
        db.alter_column(u'beacon_notificationtracker', 'notification_type', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        # Deleting model 'ViewTracker'
        db.delete_table(u'beacon_viewtracker')


        # Changing field 'NotificationTracker.notification_type'
        db.alter_column(u'beacon_notificationtracker', 'notification_type', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        'beacon.notificationtracker': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notification_detail': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
