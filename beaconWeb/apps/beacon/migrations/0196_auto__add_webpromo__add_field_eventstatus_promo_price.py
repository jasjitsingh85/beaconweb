...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WebPromo'
        db.create_table(u'beacon_webpromo', (
            ...
            ('attendee_limit', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('is_used', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['WebPromo'])

        # Adding field 'EventStatus.promo_price'
        db.add_column(u'beacon_eventstatus', 'promo_price',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'WebPromo'
        db.delete_table(u'beacon_webpromo')

        # Deleting field 'EventStatus.promo_price'
        db.delete_column(u'beacon_eventstatus', 'promo_price')
    ...
    models = {
        ...
        'beacon.eventstatus': {
            ...
            'payment_authorization': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'present': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'promo_price': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
