...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DealPlace.image_url'
        db.alter_column(u'beacon_dealplace', 'image_url', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

    def backwards(self, orm):

        # Changing field 'DealPlace.image_url'
        db.alter_column(u'beacon_dealplace', 'image_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
