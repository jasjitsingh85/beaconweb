...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealStatus.deal_status'
        db.add_column(u'beacon_dealstatus', 'deal_status',
                      self.gf('django.db.models.fields.CharField')(default='L', max_length=10),
                      keep_default=False)

        # Adding field 'DealStatus.bonus_status'
        db.add_column(u'beacon_dealstatus', 'bonus_status',
                      self.gf('django.db.models.fields.CharField')(default='L', max_length=10),
                      keep_default=False)

        # Adding field 'DealStatus.date_updated'
        db.add_column(u'beacon_dealstatus', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 6, 2, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealStatus.deal_status'
        db.delete_column(u'beacon_dealstatus', 'deal_status')

        # Deleting field 'DealStatus.bonus_status'
        db.delete_column(u'beacon_dealstatus', 'bonus_status')

        # Deleting field 'DealStatus.date_updated'
        db.delete_column(u'beacon_dealstatus', 'date_updated')
