...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DealStatus.image_key'
        db.delete_column(u'beacon_dealstatus', 'image_key')

        # Adding field 'DealStatus.image_url'
        db.add_column(u'beacon_dealstatus', 'image_url',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DealStatus.image_key'
        db.add_column(u'beacon_dealstatus', 'image_key',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DealStatus.image_url'
        db.delete_column(u'beacon_dealstatus', 'image_url')
