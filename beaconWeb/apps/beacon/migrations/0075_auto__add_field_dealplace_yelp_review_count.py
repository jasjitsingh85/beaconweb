...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealPlace.yelp_review_count'
        db.add_column(u'beacon_dealplace', 'yelp_review_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealPlace.yelp_review_count'
        db.delete_column(u'beacon_dealplace', 'yelp_review_count')
