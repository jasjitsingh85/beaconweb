...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlaceContact.priority'
        db.add_column(u'beacon_placecontact', 'priority',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PlaceContact.responded'
        db.add_column(u'beacon_placecontact', 'responded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PlaceContact.emails_received'
        db.add_column(u'beacon_placecontact', 'emails_received',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DealPlace.pipeline_status'
        db.add_column(u'beacon_dealplace', 'pipeline_status',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlaceContact.priority'
        db.delete_column(u'beacon_placecontact', 'priority')

        # Deleting field 'PlaceContact.responded'
        db.delete_column(u'beacon_placecontact', 'responded')

        # Deleting field 'PlaceContact.emails_received'
        db.delete_column(u'beacon_placecontact', 'emails_received')

        # Deleting field 'DealPlace.pipeline_status'
        db.delete_column(u'beacon_dealplace', 'pipeline_status')
