...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Emails.type'
        db.add_column(u'beacon_emails', 'type',
                      self.gf('django.db.models.fields.CharField')(default='PG', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Emails.type'
        db.delete_column(u'beacon_emails', 'type')
