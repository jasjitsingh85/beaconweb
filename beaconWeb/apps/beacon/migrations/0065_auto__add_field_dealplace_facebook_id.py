...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealPlace.facebook_id'
        db.add_column(u'beacon_dealplace', 'facebook_id',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealPlace.facebook_id'
        db.delete_column(u'beacon_dealplace', 'facebook_id')
