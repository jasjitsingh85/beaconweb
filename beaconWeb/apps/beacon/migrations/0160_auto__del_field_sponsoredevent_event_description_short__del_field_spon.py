...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SponsoredEvent.event_description_short'
        db.delete_column(u'beacon_sponsoredevent', 'event_description_short')

        # Deleting field 'SponsoredEvent.invite_prompt'
        db.delete_column(u'beacon_sponsoredevent', 'invite_prompt')

        # Adding field 'SponsoredEvent.title'
        db.add_column(u'beacon_sponsoredevent', 'title',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SponsoredEvent.event_description_short'
        db.add_column(u'beacon_sponsoredevent', 'event_description_short',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SponsoredEvent.invite_prompt'
        db.add_column(u'beacon_sponsoredevent', 'invite_prompt',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)

        # Deleting field 'SponsoredEvent.title'
        db.delete_column(u'beacon_sponsoredevent', 'title')
