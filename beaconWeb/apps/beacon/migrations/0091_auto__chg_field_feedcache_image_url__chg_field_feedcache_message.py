...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'FeedCache.image_url'
        db.alter_column(u'beacon_feedcache', 'image_url', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'FeedCache.message'
        db.alter_column(u'beacon_feedcache', 'message', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
