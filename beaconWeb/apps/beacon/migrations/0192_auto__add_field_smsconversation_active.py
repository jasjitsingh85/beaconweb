...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SmsConversation.active'
        db.add_column(u'beacon_smsconversation', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SmsConversation.active'
        db.delete_column(u'beacon_smsconversation', 'active')
