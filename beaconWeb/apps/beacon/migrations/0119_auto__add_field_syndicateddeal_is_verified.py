...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SyndicatedDeal.is_verified'
        db.add_column(u'beacon_syndicateddeal', 'is_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SyndicatedDeal.is_verified'
        db.delete_column(u'beacon_syndicateddeal', 'is_verified')
