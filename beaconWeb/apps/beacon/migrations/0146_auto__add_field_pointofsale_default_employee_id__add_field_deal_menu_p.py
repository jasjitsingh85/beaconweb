...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Employee', fields ['employee_id']
        db.create_unique(u'beacon_employee', ['employee_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Employee', fields ['employee_id']
        db.delete_unique(u'beacon_employee', ['employee_id'])
