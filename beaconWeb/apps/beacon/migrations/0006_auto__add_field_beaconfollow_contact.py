...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeaconFollow.contact'
        db.add_column(u'beacon_beaconfollow', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Contact'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeaconFollow.contact'
        db.delete_column(u'beacon_beaconfollow', 'contact_id')
