...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.additional_info'
        db.add_column(u'beacon_deal', 'additional_info',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.additional_info'
        db.delete_column(u'beacon_deal', 'additional_info')
