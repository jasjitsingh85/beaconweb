...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'beacon_rewarditem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('reward_type', self.gf('django.db.models.fields.CharField')(default='DK', max_length=2, null=True, blank=True)),
            ('isRedeemed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('beacon', ['RewardItem'])


    def backwards(self, orm):
        # Deleting model 'RewardItem'
        db.delete_table(u'beacon_rewarditem')
