...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailCampaignTracker'
        db.create_table(u'beacon_emailcampaigntracker', (
        ...
        db.send_create_signal('beacon', ['EmailCampaignTracker'])


    def backwards(self, orm):
        # Deleting model 'EmailCampaignTracker'
        db.delete_table(u'beacon_emailcampaigntracker')
