...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RegionState'
        db.create_table(u'beacon_regionstate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='region_states', to=orm['auth.User'])),
            ('region_type', self.gf('django.db.models.fields.CharField')(default='IBeacon', max_length=20)),
            ('region_state', self.gf('django.db.models.fields.CharField')(default='Enter', max_length=20)),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='region_states', to=orm['beacon.DealPlace'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['RegionState'])


    def backwards(self, orm):
        # Deleting model 'RegionState'
        db.delete_table(u'beacon_regionstate')
