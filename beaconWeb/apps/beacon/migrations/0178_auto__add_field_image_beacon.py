...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.beacon'
        db.add_column(u'beacon_image', 'beacon',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Beacon'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.beacon'
        db.delete_column(u'beacon_image', 'beacon_id')
