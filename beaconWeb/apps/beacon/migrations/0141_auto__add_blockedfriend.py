...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlockedFriend'
        db.create_table(u'beacon_blockedfriend', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('friend', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Friend', to=orm['auth.User'])),
            ('is_blocked', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['BlockedFriend'])


    def backwards(self, orm):
        # Deleting model 'BlockedFriend'
        db.delete_table(u'beacon_blockedfriend')
