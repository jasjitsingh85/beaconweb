...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealPlace.place_description'
        db.add_column(u'beacon_dealplace', 'place_description',
                      self.gf('django.db.models.fields.TextField')(default='Classic Dive. All night happy hour.'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealPlace.place_description'
        db.delete_column(u'beacon_dealplace', 'place_description')
