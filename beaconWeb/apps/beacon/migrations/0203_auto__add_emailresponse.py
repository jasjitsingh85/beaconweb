...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailResponse'
        db.create_table(u'beacon_emailresponse', (
        ...
        db.send_create_signal('beacon', ['EmailResponse'])


    def backwards(self, orm):
        # Deleting model 'EmailResponse'
        db.delete_table(u'beacon_emailresponse')
