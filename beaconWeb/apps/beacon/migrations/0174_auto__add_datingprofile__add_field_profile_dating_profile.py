...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatingProfile'
        db.create_table(u'beacon_datingprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_gender', self.gf('django.db.models.fields.CharField')(default=None, max_length=1, null=True, blank=True)),
            ('preference', self.gf('django.db.models.fields.CharField')(default=None, max_length=1, null=True, blank=True)),
            ('image_url', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('age', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('has_setup', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('beacon', ['DatingProfile'])

        # Adding field 'Profile.dating_profile'
        db.add_column(u'beacon_profile', 'dating_profile',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['beacon.DatingProfile'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DatingProfile'
        db.delete_table(u'beacon_datingprofile')

        # Deleting field 'Profile.dating_profile'
        db.delete_column(u'beacon_profile', 'dating_profile_id')
    ...
    models = {
        ...
        'beacon.profile': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'dating_profile': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['beacon.DatingProfile']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
