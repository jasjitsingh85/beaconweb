...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailStatus'
        db.create_table(u'beacon_emailstatus', (
        ...
        db.send_create_signal('beacon', ['EmailStatus'])


    def backwards(self, orm):
        # Deleting model 'EmailStatus'
        db.delete_table(u'beacon_emailstatus')
