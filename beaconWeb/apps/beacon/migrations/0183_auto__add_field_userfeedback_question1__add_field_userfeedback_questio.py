...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserFeedback.question1'
        db.add_column(u'beacon_userfeedback', 'question1',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserFeedback.question2'
        db.add_column(u'beacon_userfeedback', 'question2',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserFeedback.question3'
        db.add_column(u'beacon_userfeedback', 'question3',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserFeedback.question4'
        db.add_column(u'beacon_userfeedback', 'question4',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserFeedback.question1'
        db.delete_column(u'beacon_userfeedback', 'question1')

        # Deleting field 'UserFeedback.question2'
        db.delete_column(u'beacon_userfeedback', 'question2')

        # Deleting field 'UserFeedback.question3'
        db.delete_column(u'beacon_userfeedback', 'question3')

        # Deleting field 'UserFeedback.question4'
        db.delete_column(u'beacon_userfeedback', 'question4')
