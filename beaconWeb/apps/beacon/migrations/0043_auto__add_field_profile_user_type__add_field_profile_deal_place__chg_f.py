...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'beacon_profile', 'user_type',
                      self.gf('django.db.models.fields.CharField')(default='HT', max_length=2),
                      keep_default=False)

        # Adding field 'Profile.deal_place'
        db.add_column(u'beacon_profile', 'deal_place',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.DealPlace'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Profile.phone_number'
        db.alter_column(u'beacon_profile', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Profile.normalized_phone'
        db.alter_column(u'beacon_profile', 'normalized_phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Profile.activation_code'
        db.alter_column(u'beacon_profile', 'activation_code', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

    def backwards(self, orm):
        # Deleting field 'Profile.user_type'
        db.delete_column(u'beacon_profile', 'user_type')

        # Deleting field 'Profile.deal_place'
        db.delete_column(u'beacon_profile', 'deal_place_id')


        # Changing field 'Profile.phone_number'
        db.alter_column(u'beacon_profile', 'phone_number', self.gf('django.db.models.fields.CharField')(default=0, max_length=20))

        # Changing field 'Profile.normalized_phone'
        db.alter_column(u'beacon_profile', 'normalized_phone', self.gf('django.db.models.fields.CharField')(default=0, max_length=20))

        # Changing field 'Profile.activation_code'
        db.alter_column(u'beacon_profile', 'activation_code', self.gf('django.db.models.fields.CharField')(default=0, max_length=5))
    ...
    models = {
        ...
        'beacon.dealplace': {
            ...
            'place_description': ('django.db.models.fields.TextField', [], {}),
