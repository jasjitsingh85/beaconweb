...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlacePhotos.image_date'
        db.add_column(u'beacon_placephotos', 'image_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlacePhotos.image_date'
        db.delete_column(u'beacon_placephotos', 'image_date')
