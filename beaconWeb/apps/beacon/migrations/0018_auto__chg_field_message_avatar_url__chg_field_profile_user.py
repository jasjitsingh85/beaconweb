...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.avatar_url'
        db.alter_column(u'beacon_message', 'avatar_url', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Profile.user'
        db.alter_column(u'beacon_profile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

    def backwards(self, orm):

        # Changing field 'Message.avatar_url'
        db.alter_column(u'beacon_message', 'avatar_url', self.gf('django.db.models.fields.CharField')(default='None', max_length=100))

        # Changing field 'Profile.user'
        db.alter_column(u'beacon_profile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))
    ...
    models = {
        ...
        'beacon.beaconinvite': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 16, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
