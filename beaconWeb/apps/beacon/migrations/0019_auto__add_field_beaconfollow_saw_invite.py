...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeaconFollow.saw_invite'
        db.add_column(u'beacon_beaconfollow', 'saw_invite',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeaconFollow.saw_invite'
        db.delete_column(u'beacon_beaconfollow', 'saw_invite')
    ...
    models = {
        ...
        'beacon.beaconinvite': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
