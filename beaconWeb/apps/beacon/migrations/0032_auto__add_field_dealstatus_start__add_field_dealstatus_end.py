...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealStatus.start'
        db.add_column(u'beacon_dealstatus', 'start',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 3, 0, 0)),
                      keep_default=False)

        # Adding field 'DealStatus.end'
        db.add_column(u'beacon_dealstatus', 'end',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 3, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealStatus.start'
        db.delete_column(u'beacon_dealstatus', 'start')

        # Deleting field 'DealStatus.end'
        db.delete_column(u'beacon_dealstatus', 'end')
