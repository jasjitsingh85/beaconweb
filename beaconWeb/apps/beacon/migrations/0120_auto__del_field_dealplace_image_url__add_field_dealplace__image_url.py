...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DealPlace.image_url'
        db.delete_column(u'beacon_dealplace', 'image_url')

        # Adding field 'DealPlace._image_url'
        db.add_column(u'beacon_dealplace', '_image_url',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DealPlace.image_url'
        db.add_column(u'beacon_dealplace', 'image_url',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DealPlace._image_url'
        db.delete_column(u'beacon_dealplace', '_image_url')
    ...
    models = {
        ...
        'beacon.dealplace': {
            ...
            '_image_url': ('django.db.models.fields.CharField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
