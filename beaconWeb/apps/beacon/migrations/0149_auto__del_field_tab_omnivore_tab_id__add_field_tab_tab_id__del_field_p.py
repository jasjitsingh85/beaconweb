...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tab.omnivore_tab_id'
        db.delete_column(u'beacon_tab', 'omnivore_tab_id')
        ...
        # Deleting field 'PointOfSale.omnivore_location_id'
        db.delete_column(u'beacon_pointofsale', 'omnivore_location_id')

        # Adding field 'PointOfSale.location_id'
        db.add_column(u'beacon_pointofsale', 'location_id',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128),
                      keep_default=False)

        # Adding field 'PointOfSale.tender_type_id'
        db.add_column(u'beacon_pointofsale', 'tender_type_id',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128),
                      keep_default=False)

        # Deleting field 'Deal.menu_price_id'
        db.delete_column(u'beacon_deal', 'menu_price_id')

        # Deleting field 'Deal.menu_item_id'
        db.delete_column(u'beacon_deal', 'menu_item_id')

        # Adding field 'Deal.pos_item_id'
        db.add_column(u'beacon_deal', 'pos_item_id',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deal.pos_price_id'
        db.add_column(u'beacon_deal', 'pos_price_id',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Tab.omnivore_tab_id'
        db.add_column(u'beacon_tab', 'omnivore_tab_id',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128),
                      keep_default=False)
        ...
        # Adding field 'PointOfSale.omnivore_location_id'
        db.add_column(u'beacon_pointofsale', 'omnivore_location_id',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128, unique=True),
                      keep_default=False)

        # Deleting field 'PointOfSale.location_id'
        db.delete_column(u'beacon_pointofsale', 'location_id')

        # Deleting field 'PointOfSale.tender_type_id'
        db.delete_column(u'beacon_pointofsale', 'tender_type_id')

        # Adding field 'Deal.menu_price_id'
        db.add_column(u'beacon_deal', 'menu_price_id',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Deal.pos_item_id'
        db.delete_column(u'beacon_deal', 'pos_item_id')

        # Deleting field 'Deal.pos_price_id'
        db.delete_column(u'beacon_deal', 'pos_price_id')
    ...
    models = {
        ...
        'beacon.tab': {
            ...
            'tab_id': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
