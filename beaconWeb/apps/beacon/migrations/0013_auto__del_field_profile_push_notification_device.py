...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.push_notification_device'
        db.delete_column(u'beacon_profile', 'push_notification_device_id')


    def backwards(self, orm):
        # Adding field 'Profile.push_notification_device'
        db.add_column(u'beacon_profile', 'push_notification_device',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ios_notifications.Device'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'beacon.beaconinvite': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 2, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
