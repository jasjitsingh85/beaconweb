...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.is_underage'
        db.add_column(u'beacon_profile', 'is_underage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.is_underage'
        db.delete_column(u'beacon_profile', 'is_underage')
