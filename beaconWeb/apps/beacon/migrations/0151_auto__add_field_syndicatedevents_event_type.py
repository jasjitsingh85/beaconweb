...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SyndicatedEvents.event_type'
        db.add_column(u'beacon_syndicatedevents', 'event_type',
                      self.gf('django.db.models.fields.CharField')(default='FB', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SyndicatedEvents.event_type'
        db.delete_column(u'beacon_syndicatedevents', 'event_type')
