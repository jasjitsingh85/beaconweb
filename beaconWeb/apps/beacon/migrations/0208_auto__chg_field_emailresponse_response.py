...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailResponse.response'
        db.alter_column(u'beacon_emailresponse', 'response', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'EmailResponse.response'
        db.alter_column(u'beacon_emailresponse', 'response', self.gf('django.db.models.fields.BooleanField')())
