...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactStatus.referred_phone_number'
        db.add_column(u'beacon_contactstatus', 'referred_phone_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactStatus.referred_phone_number'
        db.delete_column(u'beacon_contactstatus', 'referred_phone_number')
