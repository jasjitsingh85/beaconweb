...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'beacon_beaconinvite', (
            ...
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_notified', null=True, to=orm['beacon.Contact'], blank=True)),
            ('beacon', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notified_beacon', to=orm['beacon.Beacon'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_notified', null=True, to=orm['auth.User'], blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 21, 0, 0), auto_now_add=True, blank=True)),
