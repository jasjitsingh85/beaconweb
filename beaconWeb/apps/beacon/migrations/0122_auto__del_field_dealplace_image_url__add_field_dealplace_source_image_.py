...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DealPlace.source_image_url'
        db.add_column(u'beacon_dealplace', 'source_image_url',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DealPlace.source_image_url'
        db.delete_column(u'beacon_dealplace', 'source_image_url')
