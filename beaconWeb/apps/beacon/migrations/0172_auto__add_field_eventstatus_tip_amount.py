...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventStatus.tip_amount'
        db.add_column(u'beacon_eventstatus', 'tip_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventStatus.tip_amount'
        db.delete_column(u'beacon_eventstatus', 'tip_amount')
