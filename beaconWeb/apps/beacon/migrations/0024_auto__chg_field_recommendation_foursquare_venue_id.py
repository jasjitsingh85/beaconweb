...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recommendation.foursquare_venue_id'
        db.alter_column(u'beacon_recommendation', 'foursquare_venue_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Recommendation.foursquare_venue_id'
        db.alter_column(u'beacon_recommendation', 'foursquare_venue_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
