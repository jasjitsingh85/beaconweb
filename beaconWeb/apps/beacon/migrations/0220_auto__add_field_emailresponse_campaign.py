...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailResponse.campaign'
        db.add_column(u'beacon_emailresponse', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.EmailStatus'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailResponse.campaign'
        db.delete_column(u'beacon_emailresponse', 'campaign_id')
