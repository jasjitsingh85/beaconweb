...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SponsoredEvent.facebook_campaign_id'
        db.add_column(u'beacon_sponsoredevent', 'facebook_campaign_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SponsoredEvent.facebook_campaign_id'
        db.delete_column(u'beacon_sponsoredevent', 'facebook_campaign_id')
