...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SponsoredEvent.description'
        db.add_column(u'beacon_sponsoredevent', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=5000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SponsoredEvent.description'
        db.delete_column(u'beacon_sponsoredevent', 'description')
