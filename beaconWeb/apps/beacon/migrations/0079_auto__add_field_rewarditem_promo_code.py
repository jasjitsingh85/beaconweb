...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RewardItem.promo_code'
        db.add_column(u'beacon_rewarditem', 'promo_code',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RewardItem.promo_code'
        db.delete_column(u'beacon_rewarditem', 'promo_code')
