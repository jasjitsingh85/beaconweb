...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beacon.place'
        db.add_column(u'beacon_beacon', 'place',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['beacon.DealPlace']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beacon.place'
        db.delete_column(u'beacon_beacon', 'place_id')
