...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SyndicatedDeal'
        db.create_table(u'beacon_syndicateddeal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('start', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('end', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='syndicated_deal', to=orm['beacon.DealPlace'])),
            ('days_active', self.gf('django.db.models.fields.BigIntegerField')(default=None, null=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['SyndicatedDeal'])


    def backwards(self, orm):
        # Deleting model 'SyndicatedDeal'
        db.delete_table(u'beacon_syndicateddeal')
    ...
    models = {
        ...
        'beacon.rewarditem': {
            ...
            'promo_code': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
