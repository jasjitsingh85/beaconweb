...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StafferNotification'
        db.create_table(u'beacon_staffernotification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.EventManager'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.SponsoredEvent'])),
            ('notification_type', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('response', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['StafferNotification'])

        # Adding field 'EventStaffer.status'
        db.add_column(u'beacon_eventstaffer', 'status',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StafferNotification'
        db.delete_table(u'beacon_staffernotification')

        # Deleting field 'EventStaffer.status'
        db.delete_column(u'beacon_eventstaffer', 'status')
    ...
    models = {
        ...
        'beacon.cashpayment': {
            ...
            'attendees': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.SponsoredEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'promo_code': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'beacon.datingmatch': {
            'Meta': {'object_name': 'DatingMatch'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dating_profile_selectee': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dating_selectee'", 'to': "orm['beacon.DatingProfile']"}),
            'dating_profile_selector': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dating_selector'", 'to': "orm['beacon.DatingProfile']"}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.SponsoredEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_selected': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'beacon.datingprofile': {
            'Meta': {'object_name': 'DatingProfile'},
            'age': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'dating_profile': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['beacon.Profile']", 'unique': 'True'}),
            'has_setup': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_url': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'preference': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1', 'null': 'True', 'blank': 'True'}),
            'user_gender': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '1', 'null': 'True', 'blank': 'True'})
        },
        'beacon.deal': {
        ...
        'beacon.emailresponse': {
            'Meta': {'object_name': 'EmailResponse'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.SponsoredEvent']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'response': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'beacon.emails': {
            ...
            'email': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'market': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.Market']"})
        },
        'beacon.emailstatus': {
            'Meta': {'object_name': 'EmailStatus'},
        ...
        'beacon.eventstaffer': {
            'Meta': {'object_name': 'EventStaffer'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.SponsoredEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_staffed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'manager': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.EventManager']"}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'})
        },
        'beacon.eventstatus': {
            'Meta': {'object_name': 'EventStatus'},
            'arrival_message_sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_statuses'", 'to': "orm['beacon.SponsoredEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_url': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'is_presale': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'present': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'refund_authorization': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'U'", 'max_length': '10'}),
            'tip_amount': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
        ...
        'beacon.image': {
            ...
            'beacon': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.Beacon']", 'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'beacon.market': {
            ...
            'longitude': ('django.db.models.fields.FloatField', [], {'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'timezone_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        'beacon.message': {
        ...
        'beacon.smsconversation': {
            'Meta': {'object_name': 'SmsConversation'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'chat_line': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.ChatLine']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.SponsoredEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user_one': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_one'", 'to': u"orm['auth.User']"}),
            'user_two': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_two'", 'to': u"orm['auth.User']"})
        },
        'beacon.sponsoredevent': {
            ...
            'chat_channel_url': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            ...
            'item_price': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.DealPlace']", 'null': 'True', 'blank': 'True'}),
            'presale_cap': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'presale_item_price': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {}),
            'title': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'web_item_price': ('django.db.models.fields.FloatField', [], {})
        },
        'beacon.staffernotification': {
            'Meta': {'object_name': 'StafferNotification'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.SponsoredEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manager': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.EventManager']"}),
            'notification_type': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
        ...
        'beacon.unsubscribe': {
            ...
            'email': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'UN'", 'max_length': '2'})
        },
        'beacon.userfeedback': {
        ...
        'beacon.webpromo': {
            'Meta': {'object_name': 'WebPromo'},
            'attendee_limit': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'code': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'content': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.SponsoredEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_used': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
