...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactStatus.second_sms_sent'
        db.add_column(u'beacon_contactstatus', 'second_sms_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactStatus.second_sms_sent'
        db.delete_column(u'beacon_contactstatus', 'second_sms_sent')
