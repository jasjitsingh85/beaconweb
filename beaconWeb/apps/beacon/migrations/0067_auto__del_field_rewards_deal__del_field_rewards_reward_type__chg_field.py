...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Rewards.deal'
        db.delete_column(u'beacon_rewards', 'deal_id')

        # Deleting field 'Rewards.reward_type'
        db.delete_column(u'beacon_rewards', 'reward_type')


        # Changing field 'Rewards.reward_value'
        db.alter_column(u'beacon_rewards', 'reward_value', self.gf('django.db.models.fields.FloatField')(default=1))

    def backwards(self, orm):
        # Adding field 'Rewards.deal'
        db.add_column(u'beacon_rewards', 'deal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Deal'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Rewards.reward_type'
        db.add_column(u'beacon_rewards', 'reward_type',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Rewards.reward_value'
        db.alter_column(u'beacon_rewards', 'reward_value', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    models = {
        ...
        'beacon.rewards': {
            ...
            'reward_value': ('django.db.models.fields.FloatField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
