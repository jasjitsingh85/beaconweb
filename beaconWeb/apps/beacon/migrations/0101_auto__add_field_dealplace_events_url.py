...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealPlace.events_url'
        db.add_column(u'beacon_dealplace', 'events_url',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealPlace.events_url'
        db.delete_column(u'beacon_dealplace', 'events_url')
