...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealHours.event_date'
        db.add_column(u'beacon_dealhours', 'event_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deal.deal_type'
        db.add_column(u'beacon_deal', 'deal_type',
                      self.gf('django.db.models.fields.CharField')(default='DT', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealHours.event_date'
        db.delete_column(u'beacon_dealhours', 'event_date')

        # Deleting field 'Deal.deal_type'
        db.delete_column(u'beacon_deal', 'deal_type')
