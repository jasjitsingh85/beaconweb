...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'beacon_cashpayment', (
            ...
            ('attendees', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['CashPayment'])


    def backwards(self, orm):
        # Deleting model 'CashPayment'
        db.delete_table(u'beacon_cashpayment')
