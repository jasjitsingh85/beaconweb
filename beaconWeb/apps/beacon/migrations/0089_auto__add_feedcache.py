...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeedCache'
        db.create_table(u'beacon_feedcache', (
            ...
            ('image_url', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['FeedCache'])


    def backwards(self, orm):
        # Deleting model 'FeedCache'
        db.delete_table(u'beacon_feedcache')
