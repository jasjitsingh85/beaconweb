...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactStatus.contact'
        db.add_column(u'beacon_contactstatus', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Contact'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContactStatus.installed_app'
        db.add_column(u'beacon_contactstatus', 'installed_app',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'ContactStatus.deal_status'
        db.alter_column(u'beacon_contactstatus', 'deal_status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.DealStatus'], null=True))

    def backwards(self, orm):
        # Deleting field 'ContactStatus.contact'
        db.delete_column(u'beacon_contactstatus', 'contact_id')

        # Deleting field 'ContactStatus.installed_app'
        db.delete_column(u'beacon_contactstatus', 'installed_app')


        # Changing field 'ContactStatus.deal_status'
        db.alter_column(u'beacon_contactstatus', 'deal_status_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['beacon.DealStatus']))
