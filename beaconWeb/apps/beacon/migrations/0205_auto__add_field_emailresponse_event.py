...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailResponse.event'
        db.add_column(u'beacon_emailresponse', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['beacon.SponsoredEvent']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailResponse.event'
        db.delete_column(u'beacon_emailresponse', 'event_id')
