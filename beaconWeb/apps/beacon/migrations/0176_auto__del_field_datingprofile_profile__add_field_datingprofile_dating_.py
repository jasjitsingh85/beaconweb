...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DatingProfile.dating_profile'
        db.add_column(u'beacon_datingprofile', 'dating_profile',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DatingProfile.dating_profile'
        db.delete_column(u'beacon_datingprofile', 'dating_profile_id')
