...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RawHappyHour.website'
        db.alter_column(u'beacon_rawhappyhour', 'website', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'RawHappyHour.city'
        db.alter_column(u'beacon_rawhappyhour', 'city', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'RawHappyHour.cuisine_label'
        db.alter_column(u'beacon_rawhappyhour', 'cuisine_label', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'RawHappyHour.start_time'
        db.alter_column(u'beacon_rawhappyhour', 'start_time', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'RawHappyHour.days'
        db.alter_column(u'beacon_rawhappyhour', 'days', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'RawHappyHour.name'
        db.alter_column(u'beacon_rawhappyhour', 'name', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'RawHappyHour.phone'
        db.alter_column(u'beacon_rawhappyhour', 'phone', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'RawHappyHour.street'
        db.alter_column(u'beacon_rawhappyhour', 'street', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'RawHappyHour.end_time'
        db.alter_column(u'beacon_rawhappyhour', 'end_time', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'RawHappyHour.website'
        db.alter_column(u'beacon_rawhappyhour', 'website', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'RawHappyHour.city'
        db.alter_column(u'beacon_rawhappyhour', 'city', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
    ...
    models = {
        ...
        'beacon.feedcache': {
            ...
            'message': ('django.db.models.fields.CharField', [], {'max_length': '10000', 'null': 'True', 'blank': 'True'}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beacon.DealPlace']"}),
