...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RawPlace.street'
        db.delete_column(u'beacon_rawplace', 'street')

        # Adding field 'RawPlace.street_address'
        db.add_column(u'beacon_rawplace', 'street_address',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RawPlace.street'
        db.add_column(u'beacon_rawplace', 'street',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'RawPlace.street_address'
        db.delete_column(u'beacon_rawplace', 'street_address')
