...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DealPlace.place_description'
        db.alter_column(u'beacon_dealplace', 'place_description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'DealPlace.place_description'
        db.alter_column(u'beacon_dealplace', 'place_description', self.gf('django.db.models.fields.TextField')(default=''))
