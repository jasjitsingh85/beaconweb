...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NotificationTracker'
        db.create_table(u'beacon_notificationtracker', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('notification_detail', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('notification_type', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['NotificationTracker'])


    def backwards(self, orm):
        # Deleting model 'NotificationTracker'
        db.delete_table(u'beacon_notificationtracker')
