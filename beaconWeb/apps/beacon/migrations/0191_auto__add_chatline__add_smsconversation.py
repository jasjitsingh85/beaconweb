...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'beacon_chatline', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['ChatLine'])

        # Adding model 'SmsConversation'
        db.create_table(u'beacon_smsconversation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_one', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_one', to=orm['auth.User'])),
            ('user_two', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_two', to=orm['auth.User'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.SponsoredEvent'])),
            ('chat_line', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.ChatLine'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['SmsConversation'])


    def backwards(self, orm):
        # Deleting model 'ChatLine'
        db.delete_table(u'beacon_chatline')

        # Deleting model 'SmsConversation'
        db.delete_table(u'beacon_smsconversation')
