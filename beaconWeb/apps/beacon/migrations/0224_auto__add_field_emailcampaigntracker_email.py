...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailCampaignTracker.email'
        db.add_column(u'beacon_emailcampaigntracker', 'email',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Emails'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailCampaignTracker.email'
        db.delete_column(u'beacon_emailcampaigntracker', 'email_id')
