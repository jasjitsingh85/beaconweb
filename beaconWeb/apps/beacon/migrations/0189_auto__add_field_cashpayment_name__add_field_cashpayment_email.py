...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CashPayment.name'
        db.add_column(u'beacon_cashpayment', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CashPayment.email'
        db.add_column(u'beacon_cashpayment', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CashPayment.name'
        db.delete_column(u'beacon_cashpayment', 'name')

        # Deleting field 'CashPayment.email'
        db.delete_column(u'beacon_cashpayment', 'email')
