...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.reward_eligibility'
        db.add_column(u'beacon_deal', 'reward_eligibility',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.reward_eligibility'
        db.delete_column(u'beacon_deal', 'reward_eligibility')
