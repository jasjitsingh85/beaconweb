...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailCampaignTracker.cash_payment'
        db.add_column(u'beacon_emailcampaigntracker', 'cash_payment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.CashPayment'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailCampaignTracker.cash_payment'
        db.delete_column(u'beacon_emailcampaigntracker', 'cash_payment_id')
