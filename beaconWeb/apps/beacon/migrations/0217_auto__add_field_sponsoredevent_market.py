...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SponsoredEvent.market'
        db.add_column(u'beacon_sponsoredevent', 'market',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.Market'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SponsoredEvent.market'
        db.delete_column(u'beacon_sponsoredevent', 'market_id')
