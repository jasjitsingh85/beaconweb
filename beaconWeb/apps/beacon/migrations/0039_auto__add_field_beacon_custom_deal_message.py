...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beacon.custom_deal_message'
        db.add_column(u'beacon_beacon', 'custom_deal_message',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beacon.custom_deal_message'
        db.delete_column(u'beacon_beacon', 'custom_deal_message')
