...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatingProfile.date_updated'
        db.add_column(u'beacon_datingprofile', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2016, 4, 6, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'DatingProfile.date_created'
        db.add_column(u'beacon_datingprofile', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2016, 4, 6, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatingProfile.date_updated'
        db.delete_column(u'beacon_datingprofile', 'date_updated')

        # Deleting field 'DatingProfile.date_created'
        db.delete_column(u'beacon_datingprofile', 'date_created')
