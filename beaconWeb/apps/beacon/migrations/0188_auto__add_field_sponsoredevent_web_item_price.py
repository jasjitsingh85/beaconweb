...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SponsoredEvent.web_item_price'
        db.add_column(u'beacon_sponsoredevent', 'web_item_price',
                      self.gf('django.db.models.fields.FloatField')(default=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SponsoredEvent.web_item_price'
        db.delete_column(u'beacon_sponsoredevent', 'web_item_price')
