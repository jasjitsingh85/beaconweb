...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailCampaignTracker.user'
        db.add_column(u'beacon_emailcampaigntracker', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailCampaignTracker.user'
        db.delete_column(u'beacon_emailcampaigntracker', 'user_id')
