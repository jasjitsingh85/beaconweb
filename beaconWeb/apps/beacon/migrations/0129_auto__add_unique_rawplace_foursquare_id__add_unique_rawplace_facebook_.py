...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'RawPlace', fields ['foursquare_id']
        db.create_unique(u'beacon_rawplace', ['foursquare_id'])

        # Adding unique constraint on 'RawPlace', fields ['facebook_id']
        db.create_unique(u'beacon_rawplace', ['facebook_id'])

        # Adding unique constraint on 'RawPlace', fields ['yelp_id']
        db.create_unique(u'beacon_rawplace', ['yelp_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RawPlace', fields ['yelp_id']
        db.delete_unique(u'beacon_rawplace', ['yelp_id'])

        # Removing unique constraint on 'RawPlace', fields ['facebook_id']
        db.delete_unique(u'beacon_rawplace', ['facebook_id'])

        # Removing unique constraint on 'RawPlace', fields ['foursquare_id']
        db.delete_unique(u'beacon_rawplace', ['foursquare_id'])
