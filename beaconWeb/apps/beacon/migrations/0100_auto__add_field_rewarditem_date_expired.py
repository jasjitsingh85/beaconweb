...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RewardItem.date_expired'
        db.add_column(u'beacon_rewarditem', 'date_expired',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RewardItem.date_expired'
        db.delete_column(u'beacon_rewarditem', 'date_expired')
