...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feedback.redemption_issue'
        db.add_column(u'beacon_feedback', 'redemption_issue',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feedback.redemption_issue'
        db.delete_column(u'beacon_feedback', 'redemption_issue')
    ...
    models = {
        ...
        'beacon.feedback': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deal_status': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'deal_feedback'", 'to': "orm['beacon.DealStatus']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
