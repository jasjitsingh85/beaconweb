...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BackgroundLocation'
        db.create_table(u'beacon_backgroundlocation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='background_locations', to=orm['auth.User'])),
            ('longitude', self.gf('django.db.models.fields.FloatField')()),
            ('latitude', self.gf('django.db.models.fields.FloatField')()),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['BackgroundLocation'])


    def backwards(self, orm):
        # Deleting model 'BackgroundLocation'
        db.delete_table(u'beacon_backgroundlocation')
