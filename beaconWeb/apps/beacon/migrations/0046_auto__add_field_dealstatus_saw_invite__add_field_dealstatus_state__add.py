...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealStatus.saw_invite'
        db.add_column(u'beacon_dealstatus', 'saw_invite',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DealStatus.state'
        db.add_column(u'beacon_dealstatus', 'state',
                      self.gf('django.db.models.fields.CharField')(default='I', max_length=10),
                      keep_default=False)

        # Adding field 'DealStatus.invited_by'
        db.add_column(u'beacon_dealstatus', 'invited_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='deal_sent_invites', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'DealStatus.checked_in_by'
        db.add_column(u'beacon_dealstatus', 'checked_in_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='deal_check_ins', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealStatus.saw_invite'
        db.delete_column(u'beacon_dealstatus', 'saw_invite')

        # Deleting field 'DealStatus.state'
        db.delete_column(u'beacon_dealstatus', 'state')

        # Deleting field 'DealStatus.invited_by'
        db.delete_column(u'beacon_dealstatus', 'invited_by_id')

        # Deleting field 'DealStatus.checked_in_by'
        db.delete_column(u'beacon_dealstatus', 'checked_in_by_id')
    ...
    models = {
        ...
        'beacon.feedback': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deal_status': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'deal_status_feedback'", 'to': "orm['beacon.DealStatus']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'beacon.groupmember': {
