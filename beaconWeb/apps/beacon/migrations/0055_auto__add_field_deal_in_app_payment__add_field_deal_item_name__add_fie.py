...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.in_app_payment'
        db.add_column(u'beacon_deal', 'in_app_payment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Deal.item_name'
        db.add_column(u'beacon_deal', 'item_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Deal.item_price'
        db.add_column(u'beacon_deal', 'item_price',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.in_app_payment'
        db.delete_column(u'beacon_deal', 'in_app_payment')

        # Deleting field 'Deal.item_name'
        db.delete_column(u'beacon_deal', 'item_name')

        # Deleting field 'Deal.item_price'
        db.delete_column(u'beacon_deal', 'item_price')
