...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.date_contacted_for_interview'
        db.add_column(u'beacon_profile', 'date_contacted_for_interview',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.date_of_interview'
        db.add_column(u'beacon_profile', 'date_of_interview',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.date_contacted_for_interview'
        db.delete_column(u'beacon_profile', 'date_contacted_for_interview')

        # Deleting field 'Profile.date_of_interview'
        db.delete_column(u'beacon_profile', 'date_of_interview')
