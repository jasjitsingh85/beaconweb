...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SyndicatedEvents.event_id'
        db.add_column(u'beacon_syndicatedevents', 'event_id',
                      self.gf('django.db.models.fields.CharField')(default='1013866935324145', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SyndicatedEvents.event_id'
        db.delete_column(u'beacon_syndicatedevents', 'event_id')
