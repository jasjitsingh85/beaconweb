...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CashPayment.promo_code'
        db.add_column(u'beacon_cashpayment', 'promo_code',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CashPayment.promo_code'
        db.delete_column(u'beacon_cashpayment', 'promo_code')
