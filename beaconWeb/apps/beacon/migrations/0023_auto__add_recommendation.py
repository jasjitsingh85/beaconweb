...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'beacon_recommendation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recommendations', to=orm['auth.User'])),
            ('foursquare_venue_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('message_text', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('beacon', ['Recommendation'])


    def backwards(self, orm):
        # Deleting model 'Recommendation'
        db.delete_table(u'beacon_recommendation')
    ...
    models = {
        ...
        'beacon.recommendation': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'foursquare_venue_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
