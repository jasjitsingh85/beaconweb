...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.date_created'
        db.add_column(u'beacon_deal', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 3, 3, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Deal.date_updated'
        db.add_column(u'beacon_deal', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 3, 3, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.date_created'
        db.delete_column(u'beacon_deal', 'date_created')

        # Deleting field 'Deal.date_updated'
        db.delete_column(u'beacon_deal', 'date_updated')
