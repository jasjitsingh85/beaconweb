...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Payment.deal_status'
        db.delete_column(u'beacon_payment', 'deal_status_id')

        # Adding field 'DealStatus.payment'
        db.add_column(u'beacon_dealstatus', 'payment',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='deal_statuses', null=True, to=orm['beacon.Payment']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Payment.deal_status'
        db.add_column(u'beacon_payment', 'deal_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['beacon.DealStatus']),
                      keep_default=False)

        # Deleting field 'DealStatus.payment'
        db.delete_column(u'beacon_dealstatus', 'payment_id')
