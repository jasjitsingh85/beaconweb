...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'beacon_friendship', (
            ...
            ('friend', self.gf('django.db.models.fields.related.ForeignKey')(related_name='friend', to=orm['auth.User'])),
            ('is_from_contact', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_auto_add', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_from_facebook', self.gf('django.db.models.fields.BooleanField')(default=False)),
