...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.notification_text'
        db.add_column(u'beacon_deal', 'notification_text',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.notification_text'
        db.delete_column(u'beacon_deal', 'notification_text')
