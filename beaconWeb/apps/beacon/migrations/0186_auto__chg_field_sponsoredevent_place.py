...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SponsoredEvent.place'
        db.alter_column(u'beacon_sponsoredevent', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.DealPlace'], null=True))

    def backwards(self, orm):

        # Changing field 'SponsoredEvent.place'
        db.alter_column(u'beacon_sponsoredevent', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['beacon.DealPlace']))
