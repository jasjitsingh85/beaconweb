...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tab.amount_paid'
        db.add_column(u'beacon_tab', 'amount_paid',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'Tab.payment_authorization'
        db.add_column(u'beacon_tab', 'payment_authorization',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tab.amount_paid'
        db.delete_column(u'beacon_tab', 'amount_paid')

        # Deleting field 'Tab.payment_authorization'
        db.delete_column(u'beacon_tab', 'payment_authorization')
