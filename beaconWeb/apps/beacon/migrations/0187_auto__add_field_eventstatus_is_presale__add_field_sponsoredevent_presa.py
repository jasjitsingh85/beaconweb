...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventStatus.is_presale'
        db.add_column(u'beacon_eventstatus', 'is_presale',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SponsoredEvent.presale_item_price'
        db.add_column(u'beacon_sponsoredevent', 'presale_item_price',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventStatus.is_presale'
        db.delete_column(u'beacon_eventstatus', 'is_presale')

        # Deleting field 'SponsoredEvent.presale_item_price'
        db.delete_column(u'beacon_sponsoredevent', 'presale_item_price')
