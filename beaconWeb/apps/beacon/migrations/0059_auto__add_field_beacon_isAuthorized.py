...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beacon.isAuthorized'
        db.add_column(u'beacon_beacon', 'isAuthorized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beacon.isAuthorized'
        db.delete_column(u'beacon_beacon', 'isAuthorized')
    ...
    models = {
        ...
        'beacon.beacon': {
            ...
            'isAuthorized': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
