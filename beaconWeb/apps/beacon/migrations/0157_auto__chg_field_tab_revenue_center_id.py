...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tab.revenue_center_id'
        db.alter_column(u'beacon_tab', 'revenue_center_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Tab.revenue_center_id'
        db.alter_column(u'beacon_tab', 'revenue_center_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=128))
