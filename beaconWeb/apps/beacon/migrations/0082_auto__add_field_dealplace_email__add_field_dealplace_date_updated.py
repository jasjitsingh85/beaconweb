...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealPlace.email'
        db.add_column(u'beacon_dealplace', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DealPlace.date_updated'
        db.add_column(u'beacon_dealplace', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 8, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealPlace.email'
        db.delete_column(u'beacon_dealplace', 'email')

        # Deleting field 'DealPlace.date_updated'
        db.delete_column(u'beacon_dealplace', 'date_updated')
