...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DatingProfile.profile'
        db.add_column(u'beacon_datingprofile', 'profile',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=10, to=orm['beacon.Profile'], unique=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DatingProfile.profile'
        db.delete_column(u'beacon_datingprofile', 'profile_id')
    ...
    models = {
        ...
        'beacon.datingprofile': {
            ...
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['beacon.Profile']", 'unique': 'True'}),
