...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedCache.content_id'
        db.add_column(u'beacon_feedcache', 'content_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeedCache.content_id'
        db.delete_column(u'beacon_feedcache', 'content_id')
