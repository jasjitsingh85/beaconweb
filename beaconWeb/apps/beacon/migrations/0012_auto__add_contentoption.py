...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContentOption'
        db.create_table(u'beacon_contentoption', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_option', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('display_location', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal('beacon', ['ContentOption'])


    def backwards(self, orm):
        # Deleting model 'ContentOption'
        db.delete_table(u'beacon_contentoption')
    ...
    models = {
        ...
        'beacon.beaconinvite': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 29, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
