...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DealPlace.place_type'
        db.add_column(u'beacon_dealplace', 'place_type',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DealPlace.place_type'
        db.delete_column(u'beacon_dealplace', 'place_type')
