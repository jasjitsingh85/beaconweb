...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'beacon_payment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deal_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beacon.DealStatus'])),
            ('payment_authorization', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('date_submitted', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('is_submitted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('beacon', ['Payment'])


    def backwards(self, orm):
        # Deleting model 'Payment'
        db.delete_table(u'beacon_payment')
