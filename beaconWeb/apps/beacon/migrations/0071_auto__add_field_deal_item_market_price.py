...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.item_market_price'
        db.add_column(u'beacon_deal', 'item_market_price',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.item_market_price'
        db.delete_column(u'beacon_deal', 'item_market_price')
